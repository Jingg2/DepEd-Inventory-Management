<?php
// filepath: c:\xampp\htdocs\OJT DEVELOPMENT\Inventory_System\api\submit_direct_assignment.php
...
$assignmentData = [
    ...
    'purpose' => $employeeInfo['purpose'] ?? 'Direct issuance recorded without request',
    'approved_by' => $adminId // Use logged-in admin's ID
];

$reqModel = new RequisitionModel();
$result = $reqModel->saveDirectAssignment($assignmentData, $items);
