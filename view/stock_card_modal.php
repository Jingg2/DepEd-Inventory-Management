...
<div id="stock-card-modal" class="modal">
    <div class="modal-content stock-card-modal-content">
        ...
        <div class="stock-card-info-header" style="padding: 15px 20px; display: flex; justify-content: space-between; align-items: flex-start; background: var(--bg-light); border-bottom: 1px solid var(--border-color);">
            <div>
                <h3 style="margin: 0 0 3px 0; color: var(--navy-800); font-size: 1rem; font-weight: 700;">Item: <span id="sc-item-name" style="color: var(--primary-emerald);"></span></h3>
                <p style="margin: 0; color: var(--slate-500); font-size: 0.85rem;"><strong>Stock No:</strong> <span id="sc-stock-no"></span></p>
            </div>
            <div style="text-align: right;">
                <p style="margin: 0 0 3px 0; color: var(--slate-500); font-size: 0.85rem;"><strong>Unit:</strong> <span id="sc-unit" style="color: var(--navy-800); font-weight: 600;"></span></p>
                <p style="margin: 0; color: var(--slate-500); font-size: 0.85rem;"><strong>Running Balance:</strong> <span id="sc-balance" style="color: var(--success-color); font-weight: 800; font-size: 0.95rem;"></span></p>
            </div>
        </div>
        ...
        <div class="sc-filter-controls" style="display: flex; flex-direction: row; align-items: flex-end; gap: 15px; padding: 10px 20px; background: white; border-bottom: 1px solid #edf2f7; flex-wrap: nowrap;">
            <div style="display: flex; flex-direction: column;">
                <label style="font-size: 0.75rem; color: var(--slate-500); margin-bottom: 4px; font-weight: 600;">From Date</label>
                <input type="date" id="sc-from-date" style="padding: 6px 10px; border: 1px solid var(--border-color); border-radius: 6px; font-size: 0.85rem; background: var(--bg-light); width: 140px;">
            </div>
            <div style="display: flex; flex-direction: column;">
            ...
            <button id="sc-filter-btn" class="btn-primary" style="padding: 6px 14px; border-radius: 6px; font-weight: 600; cursor: pointer; border: none; font-size: 0.8rem; height: 32px; white-space: nowrap;">
                <i class="fas fa-filter"></i> Filter
            </button>
            <button id="sc-reset-btn" style="padding: 6px 14px; border-radius: 6px; font-weight: 600; cursor: pointer; border: 1px solid var(--border-color); background: white; color: var(--slate-500); font-size: 0.8rem; height: 32px; white-space: nowrap;">
        ...
        <div class="modal-footer" style="padding: 15px 20px; border-top: 1px solid var(--border-color); text-align: right; display: flex; justify-content: flex-end; gap: 10px;">
            ...
            <button type="button" id="print-stock-card-btn" class="btn-primary" style="padding: 8px 16px;"><i class="fas fa-print"></i> Print PDF</button>
            <button type="button" id="download-sc-btn" class="btn-primary" style="padding: 8px 16px; background: var(--gradient-emerald);"><i class="fas fa-file-excel"></i> Export Official Excel</button>
        </div>
    </div>
</div>
